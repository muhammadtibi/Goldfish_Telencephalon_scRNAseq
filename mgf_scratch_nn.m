...
validcells=1:size(data,2); % !!!!!!!!!!!!!!!!!!!!!!!! ALL VALID CELLS 
...
elseif ii==4
legend({'m-GABA','m-DOPA','m-GLUT','g-GABA','g-GLUT'})
else
...
savefig(gcf,['tsne_all_flags_',num2str(ii),'.fig'])
    ...
    %% save 
    disp('save')
    save([direct,'/m_vs_gf_h.mat'],"prj_all",'mapped_xy','all_flags','num_har','geneid_all','data_orig_all','data','-v7.3')
    set(0,'DefaultFigureWindowStyle','normal')
